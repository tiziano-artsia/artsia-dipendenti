                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="relative">
                            <input
                                ...
                                disabled={loading}
                                className="w-full h-14 px-5 pr-14 py-0 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl text-lg text-white/95 placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/40 transition-all duration-300"
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="absolute right-4 top-1/2 -translate-y-1/2 text-white/40 hover:text-white/80 transition-colors duration-200 disabled:opacity-40"
                                tabIndex={-1}
